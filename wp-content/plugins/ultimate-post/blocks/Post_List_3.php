...
class Post_List_3{
    ...
    public function get_attributes($default = false){
        ...
        $attributes = array(
            ...
            'columns' => [
                ...
                'style' => [
                    (object)[
                        'selector'=>'{{ULTP}}.wp-block-ultimate-post-post-list-3 .ultp-block-row.ultp-block-items-wrap { grid-template-columns: repeat({{columns}}, 1fr); }'
                    ],
                ],
            ],
            'columnGridGap' => [
            ...
            'imgSpacing' => [
                ...
                'style' => [
                    ...
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-layout4 .ultp-block-item:nth-child(even) .ultp-block-content-wrap .ultp-block-image{margin-left:20px;}'
                    ],
                ],
            ],
            ...
            'pagiBorder' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-pagination-wrap .ultp-pagination li a, {{ULTP}} .ultp-next-prev-wrap ul li a, {{ULTP}} .ultp-loadmore-action'
                    ],
                ],
            ],
            'pagiShadow' => [
            ...
            'pagiHoverbg' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{ULTP}} .ultp-pagination-wrap .ultp-pagination li a:hover, {{ULTP}} .ultp-pagination li.pagination-active a, {{ULTP}} .ultp-pagination-wrap .ultp-pagination li a:focus, {{ULTP}} .ultp-next-prev-wrap ul li a:hover, {{ULTP}} .ultp-loadmore-action:hover{ {{pagiHoverbg}} }'
                    ],
                ],
            ],
            'pagiHoverBorder' => [
    ...
    public function register() {
        register_block_type( 'ultimate-post/post-list-3',
            array(
                'title' => __('Post List #3', 'ultimate-post'),
