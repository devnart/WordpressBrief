...
class Post_Grid_4{
        ...
        $attributes = array(
            ...
            'columnFlip' => [
                ...
                'style' => [
                    (object)[
                        'depends' => [
                            (object)['key'=>'columnFlip','condition'=>'==','value'=>true],
                        ],
            ...
            'overlayHeight' => [
                ...
                'style' => [
                    (object)[ 
                        'selector'=>'{{ULTP}} .ultp-block-row .ultp-block-item:first-child, {{ULTP}} .ultp-block-row.ultp-layout4, {{ULTP}} .ultp-block-row.ultp-layout1 {max-height: {{overlayHeight}};} {{ULTP}} .ultp-block-row.ultp-layout1 .ultp-block-item:not(:first-child) .ultp-block-content-overlay {height: calc({{overlayHeight}}/2);} {{ULTP}} .ultp-block-row.ultp-layout4 .ultp-block-item:not(:first-child) .ultp-block-content-overlay {height: calc({{overlayHeight}}/3);} {{ULTP}} .ultp-block-row.ultp-layout2 .ultp-block-item:nth-child(2) .ultp-block-content-overlay, {{ULTP}} .ultp-block-row.ultp-layout3 .ultp-block-item:nth-child(3) .ultp-block-content-overlay {height: calc( {{overlayHeight}}/2.5 );} {{ULTP}} .ultp-block-row.ultp-layout3 .ultp-block-item:nth-child(2) .ultp-block-content-overlay, {{ULTP}} .ultp-block-row.ultp-layout2 .ultp-block-item:nth-child(3) .ultp-block-content-overlay {height: calc( {{overlayHeight}}/1.666 );} {{ULTP}} .ultp-block-item .ultp-block-image img, {{ULTP}} .ultp-block-item .ultp-block-empty-image {width: 100%; object-fit: cover; height: 100%; }'
                    ],
                ],
            ],
            'titleShow' => [
    ...
    public function register() {
        register_block_type( 'ultimate-post/post-grid-4',
            array(
                'title' => __('Post Grid #4', 'ultimate-post'),
